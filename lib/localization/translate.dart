...
class Translate extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    "ar": {
      ...
      "favorites": "المفضلة",
      "no_favorites": "لا توجد عقارات في المفضلة",
      "start_adding_apartments":
          "ابدأ بإضافة الشقق التي تعجبك لتجدها هنا لاحقاً",
      "currency": "ر.س",
      "book_now": "احجز الآن",
      "notify": "تنبيه",
      "added_to_fav": "تمت الإضافة للمفضلة",
      "removed_from_fav": "تمت الإزالة من المفضلة",
      "booking_cancelled": "تم إلغاء اختيار التاريخ",

      // حوارات الحجز
      "success_title": "نجاح",
      "booking_success_msg": "تم إرسال طلب الحجز بنجاح",
      "error_title": "خطأ",
      "error_code": "رمز الخطأ",
      "unauthorized_error": "غير مصرح لك بالقيام بهذه العملية",
      "conflict_title": "غير متاح",
      ...
      "favorites": "المفضلة",
      "no_favorites": "لا توجد شقق في المفضلة حالياً",
      "apartment": "شقة",
      "click_to_view": "اضغط لعرض التفاصيل",
      "remove_confirm": "هل أنت متأكد من الحذف؟",
      "added_to_fav": "تمت الإضافة للمفضلة",
      "removed_from_fav": "تم الحذف من المفضلة",
    ...
    "en": {
      ...
      "favorites": "Favorites",
      "no_favorites": "No favorite apartments yet",
      "apartment": "Apartment",
      "click_to_view": "Click to view details",
      "remove_confirm": "Are you sure you want to remove this?",
      ...
      "start_adding_apartments":
          "Start adding apartments you like to find them here later",
      "currency": "SAR",
      "book_now": "Book Now",
      "notify": "Notification",
      "added_to_fav": "Added to favorites",
      "removed_from_fav": "Removed from favorites",
      "booking_cancelled": "Date selection cancelled",

      // Booking Dialogs
      "success_title": "Success",
      "booking_success_msg": "Booking request sent successfully",
      "error_title": "Error",
      "error_code": "Error Code",
      "unauthorized_error": "You are not authorized",
      "conflict_title": "Unavailable",
