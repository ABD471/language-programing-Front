...
class AppTheme {
  ...
  static ThemeData get lightTheme => ThemeData(
        ...
        textTheme: const TextTheme(
          ...
          headlineLarge: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: textDark),
          headlineMedium: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: textDark),
          headlineSmall: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: textDark),
        ...
        inputDecorationTheme: InputDecorationTheme(
          ...
          enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(borderRadius), borderSide: const BorderSide(color: Colors.black12)),
          focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(borderRadius), borderSide: BorderSide(color: primary, width: 2)),
        ),
  ...
  static ThemeData get darkTheme => ThemeData(
        ...
        inputDecorationTheme: InputDecorationTheme(
          ...
          contentPadding: const EdgeInsets.symmetric(vertical: 12, horizontal: 16),
          border: OutlineInputBorder(borderRadius: BorderRadius.circular(borderRadius), borderSide: BorderSide.none),
          enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(borderRadius), borderSide: BorderSide(color: Colors.white24)),
          focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(borderRadius), borderSide: BorderSide(color: primary, width: 2)),
        ),
        elevatedButtonTheme: ElevatedButtonThemeData(
          style: ElevatedButton.styleFrom(
