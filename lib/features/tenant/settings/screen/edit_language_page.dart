...
import 'package:apartment_rental_system/features/tenant/settings/widget/languageCard.dart';
        ...
        GradientBackground(
          child: Scaffold(
            ...
            body: Padding(
              ...
              child: Column(
                children: [
                  languageCard('en', 'English', '🇺🇸', settings),
                  SizedBox(height: 16),
                  languageCard('ar', 'العربية', '🇸🇦', settings),
                ],
              ),
            ),
          ),
