...
import 'package:apartment_rental_system/features/settings/widget/themecard.dart';
        ...
        body: Stack(
          children: [
            Padding(
              ...
              child: Column(
                children: [
                  themeCard("light_mode", Icons.light_mode, false,controller),
                  SizedBox(height: 16),
                  themeCard("dark_mode", Icons.dark_mode, true,controller),
                ],
              ),
            ),
            // Loading Overlay
